...
#### MAPDESC
This is a new map variable that should be set alongside `maptitle` and `mapauthor`. It provides a short description of the map which is shown in menus, and should only be about 1 to 2 sentences long.
